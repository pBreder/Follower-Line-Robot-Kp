    ...
    while (alerta) {          // enquanto estiver no modo alerta
      ...
      if (distancia <= 27) {  // se aproximou o sufciente do obstaculo
        ...
        if (lado == "esq") { // iniciando a curva para esquerda
          motor.set_motors(255, -80);  // comeca curva para esquerda
          delay(650);
          motor.set_motors(80, -255);  // faz a curva indo para direita
          delay(500);
          motor.set_motors(80, -200); // completa voltando para direita
          delay(930);
          motor.set_motors(200, -80); // alinha no trajeto virando rapidamente para a esquerda
          delay(390);
        }
        else if (lado == "dir") { // iniciando a curva para direita
          motor.set_motors(80, -255);  // comeca curva para direita
          delay(650);
          motor.set_motors(255, -80);  // faz a curva indo para esquerda
          delay(500);
          motor.set_motors(200, -80); // desfaz a curva voltando para esquerda
          delay(930);
          motor.set_motors(200, -80); // alinha no trajeto virando rapidamente para a direita
          delay(330);
        } 
